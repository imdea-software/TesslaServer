defmodule TesslaServer.Computation.Filter.SampleTest do
  use ExUnit.Case, async: true
  use Timex

  alias TesslaServer.Computation.Filter.Sample
  ...
  test "Should emit event with value of first stream whenever the second stream emits an event" do
    ...
    sample1 = %Event{timestamp: timestamp1, stream_id: @op2}
    sample3 = %Event{timestamp: timestamp3, stream_id: @op2, type: :progress}
    sample4 = %Event{timestamp: timestamp4, stream_id: @op2}
    sample6 = %Event{timestamp: timestamp6, stream_id: @op2}

    change0 = %Event{value: 1, stream_id: @op1, type: :change}
    change2 = %Event{timestamp: timestamp2, value: 2, stream_id: @op1, type: :change}
    change4 = %Event{timestamp: timestamp4, type: :progress, stream_id: @op1}
    change5 = %Event{timestamp: timestamp5, value: 5, stream_id: @op1, type: :change}
    change6 = %Event{timestamp: timestamp6, value: 6, stream_id: @op1, type: :change}
