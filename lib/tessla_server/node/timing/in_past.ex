defmodule TesslaServer.Node.Timing.InPast do
  @moduledoc """
  Implements a `Node` that emits a Signal holding the value true whenever an event happened on the input in a specified
