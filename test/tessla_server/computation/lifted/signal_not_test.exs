defmodule TesslaServer.Computation.Lifted.SignalNotTest do
  ...
  test "Should compute not of latest Events and notify children" do
    ...
    event0 = %Event{timestamp: timestamp0, stream_id: @op, value: true, type: :change}
    event1 = %Event{timestamp: timestamp1, stream_id: @op, type: :progress}
    event2 = %Event{
      timestamp: timestamp2, stream_id: @op, value: true, type: :change
    }
    event3 = %Event{
      timestamp: timestamp3, stream_id: @op, type: :progress
    }
    event4 = %Event{
        timestamp: timestamp4, stream_id: @op, value: false, type: :change
    }
