defmodule TesslaServer.Node.Lifted.SubTest do
  ...
  setup do
    ...
    state = %{stream_name: :sub, options: %{operand1: :number1, operand2: :number2}}
    {:ok, state: state, name: name}
  end

  test "Should substract latest Events and notify children", %{state: state, name: name} do
    adder = Sub.start state
