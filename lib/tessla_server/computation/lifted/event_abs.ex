defmodule TesslaServer.Computation.Lifted.EventAbs do
  @moduledoc """
  Implements a `Computation` that computes the absolute value of an Event Stream.
      ...
      :event ->
        {:ok,
         %Event{
           ...
           value: abs(new_event.value), type: output_event_type
         },
          state.cache
        }
