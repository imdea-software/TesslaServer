defmodule TesslaServer.Node.SpecProcessor.MinimalTest do
  ...
  test "Should Setup the minimal testcase and process Events" do
    ...
    :ok = SpecProcessor.process spec

    # :gproc.reg(gproc_tuple(0))
    # Node.add_child(:error, 0)
    ...
    # assert new_stream.id == :error
    # assert new_stream.progressed_to == {0, 0, 0}
    # assert new_stream.events == []

    # timestamp1 = {1, 0, 0}

    # variable_update_1 = %Event{stream_id: variable_update_channel, value: ["1"], timestamp: timestamp1}

    # Source.distribute(variable_update_1)
    # refute_receive _

    # function_call_1 = %Event{stream_id: function_call_channel, value: ["1"], timestamp: timestamp1}
    ...
    # timestamp2 = {2, 0, 0}
    # function_call_2 = %Event{stream_id: function_call_channel, value: ["0"], timestamp: timestamp2}
    ...
    # timestamp3 = {3, 0, 0}
    # function_call_3 = %Event{stream_id: function_call_channel, value: ["2"], timestamp: timestamp3}
    ...
    # timestamp4 = {4, 0, 0}
    # function_call_4 = %Event{stream_id: function_call_channel, value: ["3"], timestamp: timestamp4}

    # Source.distribute(function_call_4)

    # refute_receive _

    # variable_update_2 = %Event{stream_id: variable_update_channel, value: ["2"], timestamp: timestamp3}
