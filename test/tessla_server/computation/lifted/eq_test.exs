defmodule TesslaServer.Computation.Lifted.EqTest do
  ...
  test "Should compare latest Events and notify children" do
    ...
    event1_3 = %Event{
      type: :change, timestamp: timestamp3, stream_id: @op1, value: 3
    }
    event1_4 = %Event{
    ...
    event2_3 = %Event{
      type: :change, timestamp: timestamp3, stream_id: @op2, value: 3
    }
    event2_4 = %Event{
    ...
    assert_receive {_, {:process,
      %Event{type: :change, timestamp: ^timestamp1, value: false}
    }}
